    ...
    <>
            ...
            {currentType.includes('description') && 
              <TypeAnimation
                ...
                sequence={[
                  ...
                  (el) => {el.classList.remove(CURSOR_CLASS_NAME), animateSocialIcons('typeAnimationCompleted')},
                  1000,
                ]}
                wrapper="span"
      ...
      {displaysIconAnimation == 'typeAnimationCompleted' && 
        <section id="socialIconsSection" ref={socialIconsRef}>
          <a href="https://github.com/William-Libero" target="_blank" rel="noopener noreferrer">
            <FaGithubSquare className="social-icon github-icon" />
          </a>
          <a href="https://www.linkedin.com/in/williamlibero/" target="_blank" rel="noopener noreferrer">
