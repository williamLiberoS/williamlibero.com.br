...
export default function Home() {
  ...
  return (
    <>
      <section id="generalContainer" className="flex flex-col items-center justify-between">
        ...
        <section id="experienceSection" className="w-1/2 h-full mb-32 pt-24 xl:pt-20">
