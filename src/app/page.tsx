  ...
  return (
    <>
      <section className="flex flex-col items-center justify-between">
        ...
        <section id="activitySection" className="w-full mt-20 xl:mt-32 flex items-center justify-center h-full">
          <Activity/>
        </section>
        <section id="projectsSection" className="w-1/2 h-full mt-20 xl:mt-32">
          <h1 className="border-b text-2xl font-bold relative">Projetos</h1>
          <Projects/>
        </section>
        <section id="articlesSection" className="w-1/2 h-full mt-16">
          <h1 className="border-b text-2xl font-bold">Artigos</h1>
          <Articles/>
        </section>
        <section id="freelancesSection" className="w-1/2 h-full mt-16">
          <h1 className="border-b text-2xl font-bold">Freelances</h1>
          <Freelances/>
        </section>
        <section id="skillsSection" className="w-1/2 h-full mt-16">
          <h1 className="border-b text-2xl font-bold">Skills</h1>
          <Skills/>
        </section>
        <section id="skillsSection" className="w-1/2 h-full mb-32 mt-16">
