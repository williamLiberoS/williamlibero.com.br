...
export default function RootLayout({children}: { children: React.ReactNode }) {
  return (
    <html lang="en" className={"scroll-smooth light"} style={{marginTop: '0px', colorScheme: 'light'}}>
      <body className={inter.className+" light light:bg-gray-100 dark dark:bg-slate-900"}>
          <ThemeProvider>
              <Header />
              {children}
